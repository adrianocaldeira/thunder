...
namespace Thunder.Data
{
    ...
    public class DbUtil
    {
        ...
        public DbUtil()
        {
            Dialect = global::NHibernate.Dialect.Dialect.GetDialect(SessionManager.Configuration.Properties);
        }
        ...
        {
            var dialect = global::NHibernate.Dialect.Dialect.GetDialect(SessionManager.Configuration.Properties);
        ...
        {
            using (var connection = Connection(Dialect))
            {
                connection.Open();
        ...
        private static IDbConnection Connection(global::NHibernate.Dialect.Dialect dialect)
        {
